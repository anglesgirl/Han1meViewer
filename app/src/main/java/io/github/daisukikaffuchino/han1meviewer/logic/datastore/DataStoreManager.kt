...
object DataStoreManager : SettingsStore {
    ...
    private fun Preferences.toAppSettings(): AppSettings = AppSettings(
        ...
        customHostsData = string("custom_hosts_data", defaults.customHostsData), useDoH = bool("use_doh", defaults.useDoH), useEch = bool("use_ech", defaults.useEch), dohPreset = string("doh_preset", defaults.dohPreset),
